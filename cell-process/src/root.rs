...
// Import the Archived variant generated by rkyv
...
impl MyceliumRoot {
    ...
    async fn handle_child(&mut self, mut stream: UnixStream) -> Result<()> {
        ...
        // Match against the Archived enum variants
        match req {
            ArchivedMitosisRequest::Spawn { cell_name } => {
                let cell_name_str = cell_name.to_string(); // Convert ArchivedString to String
