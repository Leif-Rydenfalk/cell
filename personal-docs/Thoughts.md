Similar infra has already been used in malicious viruses and by torrent networks for many years.
We are doing it with good intents - if that is enough we will know. If not - we patch.
